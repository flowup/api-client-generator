...
describe('[helpers] to camelCase', () => {
  ...
  it('should convert dash to camelCase', () => {
    ...
    expect(toCamelCase('some-really-long-service')).toEqual('someReallyLongService');
  ...
  it('should convert some separators to camelCase', () => {
    expect(toCamelCase('folder/some_really-long.service')).toEqual('folderSomeReallyLongService');
  });
...
describe('[helpers] remove duplicate words', () => {
  ...
  it('should remove duplicates in sentence', () => {
    ...
    expect(removeDuplicateWords('shipmentShipmentAddress')).toEqual('ShipmentAddress');
