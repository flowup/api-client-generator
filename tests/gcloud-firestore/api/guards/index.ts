...
export function isArrayValue(arg: any): arg is models.ArrayValue {
  ...
  typeof arg === 'object' &&
    // values?: Value[]
    ( typeof arg.values === 'undefined' || ( Array.isArray(arg.values) && arg.values.every((item: any) => isValue(item)) ) ) &&
...
export function isBatchGetDocumentsRequest(arg: any): arg is models.BatchGetDocumentsRequest {
  ...
  typeof arg === 'object' &&
    // documents?: string[]
    ( typeof arg.documents === 'undefined' || ( Array.isArray(arg.documents) && arg.documents.every((item: any) => typeof item === 'string') ) ) &&
    // mask?: DocumentMask
...
export function isCommitRequest(arg: any): arg is models.CommitRequest {
  ...
  typeof arg === 'object' &&
    ...
    ( typeof arg.transaction === 'undefined' || typeof arg.transaction === 'string' ) &&
    // writes?: Write[]
    ( typeof arg.writes === 'undefined' || ( Array.isArray(arg.writes) && arg.writes.every((item: any) => isWrite(item)) ) ) &&
...
export function isCommitResponse(arg: any): arg is models.CommitResponse {
  ...
  typeof arg === 'object' &&
    ...
    ( typeof arg.writeResults === 'undefined' || ( Array.isArray(arg.writeResults) && arg.writeResults.every((item: any) => isWriteResult(item)) ) ) &&
...
export function isCompositeFilter(arg: any): arg is models.CompositeFilter {
  ...
  typeof arg === 'object' &&
    // filters?: Filter[]
    ( typeof arg.filters === 'undefined' || ( Array.isArray(arg.filters) && arg.filters.every((item: any) => isFilter(item)) ) ) &&
...
export function isDocument(arg: any): arg is models.Document {
  ...
  typeof arg === 'object' &&
    ...
    ( typeof arg.fields === 'undefined' || Object.values(arg.fields).every((value: any) => isValue(value)) ) &&
    // name?: string
...
export function isDocumentChange(arg: any): arg is models.DocumentChange {
  ...
  typeof arg === 'object' &&
    ...
    ( typeof arg.removedTargetIds === 'undefined' || ( Array.isArray(arg.removedTargetIds) && arg.removedTargetIds.every((item: any) => typeof item === 'number') ) ) &&
    // targetIds?: number[]
    ( typeof arg.targetIds === 'undefined' || ( Array.isArray(arg.targetIds) && arg.targetIds.every((item: any) => typeof item === 'number') ) ) &&
...
export function isDocumentMask(arg: any): arg is models.DocumentMask {
  ...
  typeof arg === 'object' &&
    // fieldPaths?: string[]
    ( typeof arg.fieldPaths === 'undefined' || ( Array.isArray(arg.fieldPaths) && arg.fieldPaths.every((item: any) => typeof item === 'string') ) ) &&
...
export function isDocumentTransform(arg: any): arg is models.DocumentTransform {
  ...
  typeof arg === 'object' &&
    ...
    ( typeof arg.fieldTransforms === 'undefined' || ( Array.isArray(arg.fieldTransforms) && arg.fieldTransforms.every((item: any) => isFieldTransform(item)) ) ) &&
...
export function isIndex(arg: any): arg is models.Index {
  ...
  typeof arg === 'object' &&
    ...
    ( typeof arg.collectionId === 'undefined' || typeof arg.collectionId === 'string' ) &&
    // fields?: IndexField[]
    ( typeof arg.fields === 'undefined' || ( Array.isArray(arg.fields) && arg.fields.every((item: any) => isIndexField(item)) ) ) &&
    // name?: string
    ( typeof arg.name === 'undefined' || typeof arg.name === 'string' ) &&
...
export function isListCollectionIdsResponse(arg: any): arg is models.ListCollectionIdsResponse {
  ...
  typeof arg === 'object' &&
    ...
    ( typeof arg.collectionIds === 'undefined' || ( Array.isArray(arg.collectionIds) && arg.collectionIds.every((item: any) => typeof item === 'string') ) ) &&
...
export function isListDocumentsResponse(arg: any): arg is models.ListDocumentsResponse {
  ...
  typeof arg === 'object' &&
    // documents?: Document[]
    ( typeof arg.documents === 'undefined' || ( Array.isArray(arg.documents) && arg.documents.every((item: any) => isDocument(item)) ) ) &&
    // nextPageToken?: string
    ( typeof arg.nextPageToken === 'undefined' || typeof arg.nextPageToken === 'string' ) &&
...
export function isListenRequest(arg: any): arg is models.ListenRequest {
  ...
  typeof arg === 'object' &&
    ...
    ( typeof arg.labels === 'undefined' || Object.values(arg.labels).every((value: any) => typeof value === 'string') ) &&
    // removeTarget?: number
...
export function isListIndexesResponse(arg: any): arg is models.ListIndexesResponse {
  ...
  typeof arg === 'object' &&
    // indexes?: Index[]
    ( typeof arg.indexes === 'undefined' || ( Array.isArray(arg.indexes) && arg.indexes.every((item: any) => isIndex(item)) ) ) &&
    // nextPageToken?: string
    ( typeof arg.nextPageToken === 'undefined' || typeof arg.nextPageToken === 'string' ) &&
...
export function isProjection(arg: any): arg is models.Projection {
  ...
  typeof arg === 'object' &&
    ...
    ( typeof arg.fields === 'undefined' || ( Array.isArray(arg.fields) && arg.fields.every((item: any) => isFieldReference(item)) ) ) &&
...
export function isStructuredQuery(arg: any): arg is models.StructuredQuery {
  ...
  typeof arg === 'object' &&
    ...
    ( typeof arg.from === 'undefined' || ( Array.isArray(arg.from) && arg.from.every((item: any) => isCollectionSelector(item)) ) ) &&
    // limit?: number
    ( typeof arg.limit === 'undefined' || typeof arg.limit === 'number' ) &&
    // offset?: number
    ( typeof arg.offset === 'undefined' || typeof arg.offset === 'number' ) &&
    // orderBy?: Order[]
    ( typeof arg.orderBy === 'undefined' || ( Array.isArray(arg.orderBy) && arg.orderBy.every((item: any) => isOrder(item)) ) ) &&
    // select?: Projection
...
export function isWriteResult(arg: any): arg is models.WriteResult {
  ...
  typeof arg === 'object' &&
    ...
    ( typeof arg.transformResults === 'undefined' || ( Array.isArray(arg.transformResults) && arg.transformResults.every((item: any) => isValue(item)) ) ) &&
    // updateTime?: string
    ( typeof arg.updateTime === 'undefined' || typeof arg.updateTime === 'string' ) &&
