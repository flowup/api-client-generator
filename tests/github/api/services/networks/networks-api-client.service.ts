...
import { DefaultHttpOptions, HttpOptions, NetworksAPIClientInterface } from './';

import * as models from '../../models';

export const USE_DOMAIN = new InjectionToken<string>('NetworksAPIClient_USE_DOMAIN');
export const USE_HTTP_OPTIONS = new InjectionToken<HttpOptions>('NetworksAPIClient_USE_HTTP_OPTIONS');
 ...
 */
@Injectable()
export class NetworksAPIClient implements NetworksAPIClientInterface {
