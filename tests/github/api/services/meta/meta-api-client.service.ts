...
import { DefaultHttpOptions, HttpOptions, MetaAPIClientInterface } from './';

import * as models from '../../models';

export const USE_DOMAIN = new InjectionToken<string>('MetaAPIClient_USE_DOMAIN');
export const USE_HTTP_OPTIONS = new InjectionToken<HttpOptions>('MetaAPIClient_USE_HTTP_OPTIONS');
 ...
 */
@Injectable()
export class MetaAPIClient implements MetaAPIClientInterface {
