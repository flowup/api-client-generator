...
export function isPullRequest(arg: any): arg is PullRequest {
  ...
  // base?: { [key: string]: any }
    ( typeof arg.base === 'undefined' || typeof arg.base === '{ [key: string]: any }' ) &&
  // body?: string
  ...
  // head?: { [key: string]: any }
    ( typeof arg.head === 'undefined' || typeof arg.head === '{ [key: string]: any }' ) &&
  // html_url?: string
  ...
  // merged_by?: { [key: string]: any }
    ( typeof arg.merged_by === 'undefined' || typeof arg.merged_by === '{ [key: string]: any }' ) &&
  // number?: number
